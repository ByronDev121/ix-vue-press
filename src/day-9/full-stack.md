...
Run the following CLI command in your `frontend` dir:

```bash
npm i bootstrap-icons
```

Import bootstrap-icons globally in `frontend/src/App.jsx`:
...
_frontend/src/components/AddEditBlogModal/index.jsx_
